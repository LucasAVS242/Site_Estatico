    ...
    <?php
            ...
            || empty($_POST['address']) || empty($_POST['contact']))
            {
                ...
                '{$lastname}',
                    ...
                    if($con->query($sql) === TRUE){
                        echo"<div class='alert alert-success'>Successfully updated
                        user</div>";

                    }else{
                        echo"<div class='alert alert-danger'>Error: There was an error
                        while updating user info</div";
                    }
        ...
        <div class="row">
            <div class="col-md-6-col-md-offset-3">
                <div class="box">
                    <h3><i class="glypgicon glyphicon-plus"></i>&nbsp;MODIFY
                    User</h3>
                    ...
                    name="userid">
                                ...
                                <textarea rows="4" name="address" class="form-control">
                                    <?php echo $row['address'];?></textarea><br>
