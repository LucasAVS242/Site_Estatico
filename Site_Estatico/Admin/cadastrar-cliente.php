...
<div class="container">
    ...
    if (isset($_POST['addnew'])) {
        ...
        if (
            ...
            empty($_POST['logradouro']) || empty($_POST['dataCadastro'])
            || empty($_POST['numero']) || empty($_POST['bairro']) || empty($_POST['cidade']) ||
            empty($_POST['cep']) || empty($_POST['estado']))
         {
            echo "<div class='alert alert-danger'>Por favor preencha os campos obrigatórios</div>";
        } else {
